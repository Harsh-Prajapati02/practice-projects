...
import LogoLight from '../../../../public/Logo2_Light.png';
    ...
    <nav className="w-full border-b px-4 py-2.5 md:px-8" id="home">
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          {resolvedTheme === "light" ? <Image src={LogoDark} width={56.1} alt="" /> : <Image src={LogoLight} width={56.1} alt="" />}
          {/* <Image src={Logo} width={56.1} alt="" /> */}
